...
const moduleName = "advancedspelleffects";
...
export default () => {
  ...
  return {
    ...
    base: `/modules/${moduleName}/`,   // Base module path that 30001 / served dev directory.
    ...
    server: {
      ...
      open: false,
      proxy: {
        [`^(/modules/${moduleName}/languages)`]: 'http://127.0.0.1:30000',
        [`^(?!/modules/${moduleName}/)`]: 'http://127.0.0.1:30000',
